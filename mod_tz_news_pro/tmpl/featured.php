...
$document->addStyleSheet(JUri::base() . 'modules/mod_tz_news_pro/css/featured.css');
?>
        ...
        <?php if (isset($list) && !empty($list)) :
            foreach ($list as $item) :
                ...
                <?php if (!$media or ($media != null  AND $media->type != 'quote' AND $media->type != 'link' AND $media->type != 'audio')): ?>
                    <li>
                        <div class="tz_featured_default">
                            <?php if ($title == 1) : ?>
                                <h6 class="tz_featured_title">
                                ...
                                <div class="dv1">
                                    ...
                                    <?php if ($des == 1) : ?>
                                        ...
                                        <?php if ($limittext) :
                                            ...
                                            <?php if ($readmore == 1) : ?>
                                                <span class="tz_featured_readmore">
